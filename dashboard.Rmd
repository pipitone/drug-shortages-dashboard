...
Row
------------------------------------- 
### COVID-19 Indicator Medicines {data-width=300}
The figure below shows the medications from a list of medicines we are tracking to assess for COVID-related shortages:

```{r}
# To add: propofol, rocuronium, cisatracurium, ketamine, midazolam, norepinephrine, phenylephrine, fentanyl
covid_meds = tibble(
  ATC =   c("R03AC", "N01A", "P01BA", 
            "N02BE01",  "M03AC", "N05CD", 
            "C01CA"),
  Description = c("Respiratory Beta Agonists",  "Anesthetics (includes opioid, ketamines)",  "Quinolones", 
